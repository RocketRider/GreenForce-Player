...
Macro __Sprite2D_Debug(sText)
  ;Debug sText
  WriteLog(sText, #LOGLEVEL_DEBUG)
EndMacro

Macro __Sprite2D_Error(sText)
  ;Debug sText  
...
ProcedureDLL Sprite2D_Start() 
  ...
  Protected *Quad.DisplaySpriteColor, c, *IndexBuffer, Count
  *D3DDevice9.IDirect3DDevice9 = g_S3DGlbs\D3DDevice9
  ...
  *D3DDevice9\SetRenderState(#D3DRS_CLIPPING,#True)
  ...
  If g_S3DGlbs\Sprite3DIndexBuffer=0
    ...
    If g_S3DGlbs\Sprite3DIndexBuffer
      *IndexBuffer=g_S3DGlbs\Sprite3DIndexBuffer
...
Protected *Tex.IDirect3DTexture9, Depth, bOk = #False, TmpImage = #Null, lr.D3DLOCKED_RECT
Protected *ImageBuffer, ImagePitch, y
If Image And *D3DDevice
  If ImageWidth(Image)>0 And ImageHeight(Image)>0
...
;DON'T FREES THE IMAGE!!!
Procedure LoadD3DTexture9FromPBImage(*D3DDevice.IDirect3DDevice9, Image.i, bResizeToPowerOf2.i = #False, MaxSize = 512, *orgWidth.long = #Null, *orgHeight.long = #Null)
  Protected NewWidth, NewHeight, TmpImage = #Null, *Tex.IDirect3DTexture9
  If *D3DDevice
    If Image <> #Null
      If *orgWidth
      ...
      If bResizeToPowerOf2
        ...
        Else
          __Sprite2D_Error("LoadD3DTexture9FromPBImage: cannot copy image")        
        EndIf
      EndIf     
    Else 
      __Sprite2D_Error("LoadD3DTexture9FromPBImage: Image is null")
    EndIf
    ...
    *Tex.IDirect3DTexture9 = __LoadD3DTexture9FromImage(*D3DDevice, Image)
    ...
    If *Tex = #Null
      __Sprite2D_Error("LoadD3DTexture9FromPBImage: CreateTexture failed")
    EndIf
     ProcedureReturn *Tex
  EndIf
EndProcedure
...
Procedure LoadD3DTexture9FromImage(*D3DDevice.IDirect3DDevice9, sFile.s, bResizeToPowerOf2.i = #False, MaxSize = 512, *orgWidth.long = #Null, *orgHeight.long = #Null)   
  Protected Image, NewWidth, NewHeight, TmpImage = #Null, *Tex.IDirect3DTexture9
  If *D3DDevice
    ...
    If Image <> #Null
      ...
      EndIf     
    Else 
      __Sprite2D_Error("LoadD3DTexture9FromImage: Image is null")
    EndIf
